  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-white to-transparent py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Manage your projects <br /> with ease <br />
      </motion.h1>
    </LampContainer>
  );
}
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(var(--conic-position), #ffffff00, #ffffff00)`, // Use white with alpha 0 for the bluish light effect
          }}
